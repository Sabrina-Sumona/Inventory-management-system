...
interface CustomerContactFormState {
  name: string;
  designation: string;
  department: string;
...
export function CustomerContactForm({
  ...
  const [form, setForm] =
    useState<CustomerContactFormState>(
  ...
  async function handleSubmit(
    ...
    const payload: CustomerContactPayload = {
      ...
      email:
        optionalString(form.email),

      phone:
        optionalString(form.phone),
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="customer-contact-form-title"
    ...
    >
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5">
          <div>
            <h2
              id="customer-contact-form-title"
          ...
          <button
            ...
            onClick={onCancel}
            disabled={isSaving}
            aria-label="Close customer contact form"
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4">
                ...
                <span>
                  ...
                  <span className="mt-1 block text-xs text-slate-500">
                    ...
                    remove the primary status from
              ...
              <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 p-4">
                ...
                <span>
                  ...
                  <span className="mt-1 block text-xs text-slate-500">
                    Inactive contacts remain stored
                    but are marked unavailable for
